...
@Service
public class SeguridadPassService {

	public SeguridadPassService() { // CONSTRUCTOR
	...
	public String encriptarPass(String password) { // ENCRIPTADOR DE CONTRASEÑA
		...
		for (int i = 0; i < 12; i++) { // CATIDAD DE ROUND QUE SE LE INYECTA LA SALT
			String hashedPassword = passwordEncoder.encode(password); // CREAMOS LA VARIABLE HASHED Y ENCONDOTAMOS EL
																		// PASSWORD QUE VIENE DEL USUARIO
